...
public class ToAttendanceIT215 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_attendance_it215);
        ...
        currentUser = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("IT215").child("absence");
