    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog=new ProgressDialog(TeacherUpdate.this);
                            ...
                            mUserDatabase.child("image").setValue(download_url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(TeacherUpdate.this, "Uploading  Successful", Toast.LENGTH_LONG).show();

                                    }
                                }
                            });
                        } else {
                            Toast.makeText(TeacherUpdate.this, "Error", Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
...
public void showData(DataSnapshot dataSnapshot){
    ...
    for (DataSnapshot ds : dataSnapshot.getChildren()) {
        ...
        Picasso.with(TeacherUpdate.this).load(image).placeholder(R.drawable.default_img).into(mDisplayImage);
    }
}
