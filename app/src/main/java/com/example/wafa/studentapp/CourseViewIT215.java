...
public class CourseViewIT215 extends AppCompatActivity {
    ...
    private SectionsPagerAdapterofCourses4 mSectionsPagerAdapter;     //courses tab
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapterofCourses4(getSupportFragmentManager());
    ...
    /*public void filesUploads(View v ){
        ...
        Intent i = new Intent(CourseViewIT215.this, FilesIT473Fragment.class);
        startActivity(i);
    }
