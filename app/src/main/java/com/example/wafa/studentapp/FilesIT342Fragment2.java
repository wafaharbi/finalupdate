 ...
 */
public class FilesIT342Fragment2 extends Fragment {
...
//Android Layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView=inflater.inflate(R.layout.fragment_files_it342_fragment2, container, false);
        ...
        mAttendance = FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("IT342").child("absence");
