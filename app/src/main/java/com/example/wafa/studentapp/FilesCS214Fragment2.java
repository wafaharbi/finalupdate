 ...
 */
public class FilesCS214Fragment2 extends Fragment {
...
//Android Layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView=inflater.inflate(R.layout.fragment_files_cs214_fragment2, container, false);
        ...
        mAttendance = FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("CS214").child("absence");
