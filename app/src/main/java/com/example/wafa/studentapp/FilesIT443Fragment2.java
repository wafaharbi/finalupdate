 ...
 */
public class FilesIT443Fragment2 extends Fragment {
...
//Android Layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView = inflater.inflate(R.layout.fragment_files_it443_fragment2, container, false);
        ...
        mAttendance = FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("IT443").child("absence");
