...
public class StudentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView=inflater.inflate(R.layout.fragment_students, container, false);



        mUserList = (RecyclerView)  mMainView.findViewById(R.id.srudents_list);
            ...
            protected void populateViewHolder(final UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(getContext(), MessageTeacherStudent.class);
