...
public class ToAttendanceCS214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_attendance_cs214);
        ...
        currentUser = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("CS214").child("absence");
