...
public class CourseSelectTI473 extends AppCompatActivity {
    ...
    private SectionsPagerAdapterofCoursesTeacher3 mSectionsPagerAdapter;     //courses tab
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapterofCoursesTeacher3(getSupportFragmentManager());
