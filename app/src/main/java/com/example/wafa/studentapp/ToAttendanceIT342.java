...
public class ToAttendanceIT342 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_attendance_it342);
        ...
        currentUser = FirebaseDatabase.getInstance().getReference().child("Student").child(user_id).child("IT342").child("absence");
