...
public class CourseSelectCS214 extends AppCompatActivity {
    ...
    private SectionsPagerAdapterofCoursesTeacher6 mSectionsPagerAdapter;     //courses tab
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapterofCoursesTeacher6(getSupportFragmentManager());
