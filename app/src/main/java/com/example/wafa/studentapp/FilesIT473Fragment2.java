 ...
 */
public class FilesIT473Fragment2 extends Fragment {
...
//Android Layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView= inflater.inflate(R.layout.fragment_files_it473_fragment2, container, false);
        ...
        mAttendance =  FirebaseDatabase.getInstance().getReference().child("Student").child(current_uid).child("IT473").child("absence");
