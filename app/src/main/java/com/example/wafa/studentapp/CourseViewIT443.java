...
public class CourseViewIT443 extends AppCompatActivity {
    ...
    private SectionsPagerAdapterofCourses2 mSectionsPagerAdapter;     //courses tab
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new SectionsPagerAdapterofCourses2(getSupportFragmentManager());
...
/*
    public void filesUploads(View v) {
        ...
        Intent i = new Intent(CourseViewIT443.this, FilesIT473Fragment.class);
        startActivity(i);
    }
