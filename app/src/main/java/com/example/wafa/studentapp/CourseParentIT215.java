...
public class CourseParentIT215 extends AppCompatActivity {
    ...
    public void showAttendance(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()){
            ...
            final String weeks = attendance.setWeek(dataSnapshot.child("IT215").child("absence").child("week").getValue().toString());
            final String days = attendance.setDay(dataSnapshot.child("IT215").child("absence").child("day").getValue().toString());
            final String dates = attendance.setDate(dataSnapshot.child("IT215").child("absence").child("date").getValue().toString());
    ...
    public  void show(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()) {
            ...
            final int quiz = info.setQuize((Integer)dataSnapshot.child("IT215").child("quiz").getValue(Integer.class));
            final int mid = info.setMid((Integer)dataSnapshot.child("IT215").child("mid").getValue(Integer.class));
            final int finals = info.setFinals((Integer)dataSnapshot.child("IT215").child("finals").getValue(Integer.class));
